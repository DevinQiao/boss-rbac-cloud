...
public class BossAuthorizationServerConfigure extends AuthorizationServerConfigurerAdapter {
    ...
    @Resource
    private BossAuthProperties authProperties;

    @Resource
    private BossWebResponseExceptionTranslator exceptionTranslator;
