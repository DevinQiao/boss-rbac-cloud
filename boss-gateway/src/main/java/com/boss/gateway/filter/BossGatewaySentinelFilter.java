...
import com.boss.gateway.fallback.BossGatewayBlockFallbackProvider;
...
@Slf4j
@Component
public class BossGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new BossGatewayBlockFallbackProvider());
        initGatewayRules();
    }

    /**
     * 定义验证码请求限流
     * 60秒内同一个IP，同一个key最多访问10次
     */
