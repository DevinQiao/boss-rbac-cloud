...
import com.boss.gateway.handler.BossGatewayExceptionHandler;
 ...
 */
@Configuration
public class BossGatewayErrorConfigure {
    ...
    public ErrorWebExceptionHandler errorWebExceptionHandler(ErrorAttributes errorAttributes) {
        BossGatewayExceptionHandler exceptionHandler = new BossGatewayExceptionHandler(
